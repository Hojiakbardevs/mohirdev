  ...
  original: {
    ...
    OBSTACLES: [
      ...
      },
      {
        ...
        minGap: 9999,
        minSpeed: 0,
        collisionBoxes: [new CollisionBox(0, 0, 32, 25)],
      },
    ],
    BACKGROUND_EL: {
      CLOUD: {
  ...
  altgame: {
    ...
    OBSTACLES: [
      ...
      },
      {
        ...
        minGap: 120,
        minSpeed: 5,
        collisionBoxes: [new CollisionBox(0, 0, 42, 50)],
      },
      {
        type: "OBSTACLE6",
        width: 56,
    ...
    LINES: [{ SOURCE_X: 2, SOURCE_Y: 3, WIDTH: 600, HEIGHT: 12, YPOS: 128 }],
  },
};
...
GameOverPanel.prototype = {
  ...
  clearGameOverTextBounds(dimensions) {
    ...
    this.canvasCtx.clearRect(
      Math.round(this.canvasDimensions.WIDTH / 2 - dimensions.TEXT_WIDTH / 2),
      Math.round((this.canvasDimensions.HEIGHT - 25) / 3),
      dimensions.TEXT_WIDTH,
      dimensions.TEXT_HEIGHT + 4
    );
    this.canvasCtx.restore();
  },
  ...
  placeStars() {
    ...
    for (let i = 0; i < NightMode.config.NUM_STARS; i++) {
      ...
      if (IS_HIDPI) {
        ...
        this.stars[i].sourceY =
          spriteDefinitionByType.original.LDPI.STAR.y +
